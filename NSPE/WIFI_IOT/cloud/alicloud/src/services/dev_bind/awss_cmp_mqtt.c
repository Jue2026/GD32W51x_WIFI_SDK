...
const struct awss_cmp_couple awss_online_couple[] = {
    ...
    {-1, TOPIC_ZC_CHECKIN,         (void *)awss_registrar_cloud_checkin},
    {-1, TOPIC_ZC_ENROLLEE_REPLY,  (void *)awss_registrar_enr_found_reply},
    {-1, TOPIC_ZC_CIPHER_REPLY,    (void *)awss_registrar_enr_cipher_reply},
#endif
