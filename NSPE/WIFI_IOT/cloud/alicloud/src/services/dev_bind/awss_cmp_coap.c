...
const struct awss_cmp_couple awss_local_couple[] = {
    ...
    {AWSS_LC_INIT_BIND,                      TOPIC_NOTIFY,                        (void *)awss_registrar_enr_bind_monitor},
    {AWSS_LC_INIT_BIND,                      TOPIC_AWSS_CONNECTAP_NOTIFY,         (void *)awss_registrar_enr_bind_monitor},
#endif
#endif
    {AWSS_LC_INIT_BIND,                      TOPIC_GETDEVICEINFO_MCAST,           (void *)online_mcast_get_device_info},
    {AWSS_LC_INIT_BIND,                      TOPIC_GETDEVICEINFO_UCAST,           (void *)online_ucast_get_device_info}
};
