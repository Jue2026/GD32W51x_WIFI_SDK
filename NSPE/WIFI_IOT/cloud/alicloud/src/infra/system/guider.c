...
int iotx_guider_set_dynamic_mqtt_url(char *p_mqtt_url)
{
    ...
    /* For demo, GD modified */
    memset(mqtt_url_str, 0, 256);
    strncpy(mqtt_url_str, p_mqtt_url, len);
    ret = 0;
    /* GD modified end */
