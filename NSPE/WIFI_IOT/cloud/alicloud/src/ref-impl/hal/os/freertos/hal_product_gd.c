...
int HAL_GetFirmwareVersion(char *version)
{
    ...
    return HAL_Snprintf(version, FIRMWARE_VERSION_MAXLEN - 1, "%d.%d.%d", (ver >> 24), ((ver << 8) >> 24), (ver & 0xFFFF));
}
...
#ifdef __DEMO__
    strncpy(cid_str, "76:ba:ed:20:00:56", HAL_CID_LEN);
