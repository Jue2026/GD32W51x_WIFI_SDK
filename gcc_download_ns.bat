...
if "%DEBUGGER%" == "JLINK" goto download_by_jlink
if "%DEBUGGER%"=="GDLINK" goto download_by_cmsisdap
if "%DEBUGGER%"=="DAPLINK" goto download_by_cmsisdap
goto printhelp
...
:: Download_by_GDLINK/DAPLINK
:download_by_cmsisdap
